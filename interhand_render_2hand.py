...
def render(mesh, face, focal, princpt, img, prev_depth):
    ...
    return rgb, img, prev_depth

# mano layer
smplx_path = '/root/junho/mano_v1_2/models'
...
root_path = '/root/junho/interhand'
...
img_path_list_0 = sorted(glob(osp.join(img_root_path, split, '*', '02*', '*', '*.jpg')))
img_path_list_1 = sorted(glob(osp.join(img_root_path, split, '*', '03*', '*', '*.jpg')))
